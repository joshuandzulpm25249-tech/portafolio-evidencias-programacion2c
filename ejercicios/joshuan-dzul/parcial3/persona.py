"""
crea una clase persona con ls siguientes atributos: nombre, edad, genero y nacionalidad
Agrega un metodo para imprimir los datos de la persona y otro metodo para calcular el año
de nacimiento de la persona.
crea un objeto de la clase personal y utiliza los metodos para mostrar su informacion y
